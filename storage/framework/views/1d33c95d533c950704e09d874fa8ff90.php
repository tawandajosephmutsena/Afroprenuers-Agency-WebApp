...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['id','label','labelSrOnly','helperText','hint','hintIcon','required','statePath']));
...
foreach (array_filter((['id','label','labelSrOnly','helperText','hint','hintIcon','required','statePath']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-forms::components.field-wrapper.index','data' => ['id' => $id,'label' => $label,'labelSrOnly' => $labelSrOnly,'helperText' => $helperText,'hint' => $hint,'hintIcon' => $hintIcon,'required' => $required,'statePath' => $statePath]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH /Users/mac/Herd/mho/storage/framework/views/35b95b0d1d90dcb52e6d80fb1ad942bc.blade.php ENDPATH**/ ?>