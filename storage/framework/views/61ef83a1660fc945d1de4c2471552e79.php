...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['partnerLogos','topButtonLink','topbutton','title','content','button01Link','button01','button02Link','title02']));
...
foreach (array_filter((['partnerLogos','topButtonLink','topbutton','title','content','button01Link','button01','button02Link','title02']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?><?php /**PATH /Users/mac/Herd/an/storage/framework/views/da0c620a5289e09edf15fd7b69757c38.blade.php ENDPATH**/ ?>