...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="<?php echo e(asset('storage/assets/site_logo.png')); ?>" class="h-8" alt="Flowbite Logo" />
        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="/" class="flex items-center">
                  <img src="<?php echo e(asset('storage/assets/site_logo.png')); ?>" class="h-8 me-3" alt="FlowBite Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
              </a>
          </div>
...
<?php /**PATH /Users/mac/Herd/an/resources/views/flow.blade.php ENDPATH**/ ?>