<?php if(\Pboivin\FilamentPeek\Support\View::needsPreviewModal()): ?>
    <div
        role="alertdialog"
        aria-modal="true"
        ...
        x-cloak
    >
        <?php if(\Pboivin\FilamentPeek\Support\View::needsBuilderEditor()): ?>
            <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-981193140-0', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="filament-peek-panel filament-peek-preview">
            <div class="filament-peek-panel-header">
                ...
                <?php if(config('filament-peek.devicePresets', false)): ?>
                    <div class="filament-peek-device-presets">
                        <?php $__currentLoopData = config('filament-peek.devicePresets'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presetName => $presetConfig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button
                                type="button"
...
<?php endif; ?>
<?php /**PATH /Users/mac/Herd/mho/vendor/pboivin/filament-peek/src/../resources/views/preview-modal.blade.php ENDPATH**/ ?>