            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center gap-4">
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($stat->getIcon()): ?>
                            <?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
<?php $component = Illuminate\View\DynamicComponent::resolve(['component' => $stat->getIcon()] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        <h2 class="text-sm font-medium text-gray-500">
                            <?php echo e($stat->getLabel()); ?>

                        </h2>

                        <p class="text-3xl font-semibold">
                            <?php echo e($stat->getValue()); ?>

                        </p>

                        <!--[if BLOCK]><![endif]--><?php if($stat->getDescription()): ?>
                            <p class="text-sm text-gray-500">
                                <?php echo e($stat->getDescription()); ?>
...
<?php endif; ?>
<?php /**PATH /Users/mac/Herd/mho/resources/views/filament/Widgets/kanban-stats.blade.php ENDPATH**/ ?>