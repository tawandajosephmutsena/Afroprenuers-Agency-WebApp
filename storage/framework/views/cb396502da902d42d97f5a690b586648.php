        ...
        <!--[if BLOCK]><![endif]--><?php if(count($containers)): ?>
            ...
            >
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $containers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uuid => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    >
                        <!--[if BLOCK]><![endif]--><?php if($reorderActionIsVisible || $moveUpActionIsVisible || $moveDownActionIsVisible || $hasBlockIcons || $hasBlockLabels || $editActionIsVisible || $cloneActionIsVisible || $deleteActionIsVisible || $isCollapsible || $visibleExtraItemActions): ?>
                            <div
                            ...
                            >
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($hasBlockIcons && filled($blockIcon)): ?>
...
<?php endif; ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($hasBlockLabels): ?>
                                    <h4
                                        class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    >
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($hasBlockNumbers): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($editActionIsVisible || $cloneActionIsVisible || $deleteActionIsVisible || $isCollapsible || $visibleExtraItemActions): ?>
                                    <ul
                                    ...
                                    >
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($editActionIsVisible): ?>
                                            <li x-on:click.stop>
                        ...
                        >
                            <!--[if BLOCK]><![endif]--><?php if($hasBlockPreviews && $item->getParentComponent()->hasPreview()): ?>
                                <div
                                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($editActionIsVisible && (! $hasInteractiveBlockPreviews)): ?>
                                    <div
...
<?php endif; ?>
<?php /**PATH /Users/mac/Herd/an/vendor/filament/forms/src/../resources/views/components/builder.blade.php ENDPATH**/ ?>