            ...
            <ul class="divide-y divide-gray-300 dark:divide-gray-700">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->getCachedData(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex flex-row items-center justify-between p-2 group gap-x-1">
                        <h5 class="grow text-sm font-medium text-gray-500 dark:text-gray-400 group-hover:text-primary-500 dark:group-hover:text-primary-400 cursor-pointer truncate w-10 sm:w-full"><?php echo e(filled($record['url']) ? $record['url'] : 'Unknown'); ?></h5>
...
<?php $component->withAttributes(['color' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($color),'class' => 'tabular-nums shrink-0']); ?>
                            <?php echo e(FilamentGoogleAnalytics::thousandsFormater($record['pageViews'])); ?>
...
<?php /**PATH /Users/mac/Herd/an/vendor/bezhansalleh/filament-google-analytics/src/../resources/views/widgets/top-referrers-list.blade.php ENDPATH**/ ?>