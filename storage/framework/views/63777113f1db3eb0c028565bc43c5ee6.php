    ...
    <button 
        ...
        <div class="flex gap-2">
            ...
            <span class="fi-btn-label">
                <?php echo e(!$hasSortOrder ? __('filasortable::filasortable.Enable') : __('filasortable::filasortable.Disable')); ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var sortable = Sortable.create(el, {
            ...
            onEnd: function (evt) {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('updateSortOrder', itemValues);
            }
        });
    });
</script>
<?php /**PATH /Users/mac/Herd/mho/resources/views/vendor/filasortable/livewire/sortable-action-component.blade.php ENDPATH**/ ?>