...
$__html = app('livewire')->mount($__name, $__params, 'lw-1234237111-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
        ...
        <div class="flex w-full flex-grow items-center justify-center z-index: 10">
        <a href="/" class="text-sm font-bold"><- Back to homepage
</a>
        ...
        >
            ...
            >
                ...
                <div class="mt-4 p-2"><p class="text-sm">© 2024 Mhondoro Inc. All rights reserved.</p></div>
            </main>
...
<?php endif; ?>
<?php /**PATH /Users/mac/Herd/an/resources/views/vendor/filament-panels/components/layout/simple.blade.php ENDPATH**/ ?>