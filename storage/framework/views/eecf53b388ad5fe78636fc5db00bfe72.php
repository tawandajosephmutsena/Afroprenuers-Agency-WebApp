...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['heading','content','buttonText','privacyText','privacyUrl']));
...
foreach (array_filter((['heading','content','buttonText','privacyText','privacyUrl']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($heading),'content' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($content),'button_text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($buttonText),'privacy_text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($privacyText),'privacy_url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($privacyUrl)]); ?>
...
<?php endif; ?><?php /**PATH /Users/mac/Herd/an/storage/framework/views/192c170c81cc98921fdbb543d9ef0fb2.blade.php ENDPATH**/ ?>