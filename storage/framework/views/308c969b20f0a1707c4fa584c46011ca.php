        ...
        <!--[if BLOCK]><![endif]--><?php if(count($containers)): ?>
            ...
            >
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $containers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uuid => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    >
                        <!--[if BLOCK]><![endif]--><?php if($isReorderableWithDragAndDrop || $isReorderableWithButtons || $hasBlockLabels || $isCloneable || $isDeletable || $isCollapsible || count($visibleExtraItemActions)): ?>
                            <div
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($isAddable && $addBetweenAction->isVisible()): ?>
                            <li class="relative -top-2 !mt-0 h-0">
                                ...
                                >
                                    ...
                                    >
                                        <!--[if BLOCK]><![endif]--><?php if($blockPickerStyle === BlockPickerStyle::Dropdown): ?>
...
<?php endif; ?>
<?php /**PATH /Users/mac/Herd/an/vendor/z3d0x/filament-fabricator/src/../resources/views/components/forms/components/page-builder.blade.php ENDPATH**/ ?>