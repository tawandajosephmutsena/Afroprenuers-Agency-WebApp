        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="#" class="flex items-center">
                    <img src="{{ $footerSettings?->logo ? \Awcodes\Curator\Models\Media::find($footerSettings->logo)->path : asset('storage/assets/site_logo.png') }}" class="h-16 me-3" alt="Site Logo" />
                </a>
            </div>
